...
public class ClickhouseReader extends Reader {
    ...
    public static class Job extends Reader.Job {
        ...
        public void init() {
            ...
            this.originalConfig.set(Constant.FETCH_SIZE, userConfigedFetchSize == null ? Integer.MIN_VALUE : userConfigedFetchSize);
    ...
    public static class Task extends Reader.Task {
        ...
        public void startRead(RecordSender recordSender) {
            LOG.info("slice config: " + this.readerSliceConfig.toString());
            LOG.info("constant[fetchSize]" + Constant.FETCH_SIZE);
